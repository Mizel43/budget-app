...
- расчёт и отображение всех сумм в китайских юанях (CNY, ¥);
- несколько доходов, обязательные расходы, резерв и целевой остаток;
- категории расходов с архивом и аналитикой по периодам;
...
`npm test` использует встроенный Node test runner и покрывает расчёт в целых фэнях, даты Guangzhou, rollover, миграцию V3, категории, аналитику, периоды, presentation и sync-инварианты.
