...
- Создать категорию, выбрать её при быстром добавлении расхода и убедиться, что появился цветной бейдж.
- Открыть «Детали»: категория и «Без категории» должны образовать круговую диаграмму текущего периода.
- Выбрать прошлый период в selector и убедиться, что диаграмма использует его расходы.
- Архивировать категорию: она должна исчезнуть из выбора новых расходов, но остаться в истории и диаграмме.
- Восстановить категорию из «Архива категорий»: она снова доступна для нового расхода с тем же цветом.
- На ширине 390 px доходы и обязательные расходы отображаются карточками без горизонтальной прокрутки.
